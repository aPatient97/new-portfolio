...
function BfhCard() {
  return (
    ...
    <section className="container">
      <picture>
        <source media="(min-width: 900px)" className='image' srcSet='/images/bfh-large.webp' alt="big fact hunt quiz website screenshot" />
        <source media="(min-width: 900px)" className='image' srcSet='/images/bfh-large.jpg' alt="big fact hunt quiz website screenshot" />
        <img className='image' src='images/facthunt.jpg' alt="big fact hunt quiz website screenshot" />
      </picture>
